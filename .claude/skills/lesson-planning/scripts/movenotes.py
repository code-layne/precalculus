...
"Teacher Notes" block, and skips keys with no note.
    ...
    python3 movenotes.py unit02/lesson03          # migrate
    python3 movenotes.py unit02/lesson03 --check   # report only

See references/conventions.md ("The five conventions" -> teachernote).
"""
