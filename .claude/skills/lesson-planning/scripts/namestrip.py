...
Deliberately NOT touched:
  ...
  * anything outside a lesson directory (unit covers, and unitXX/tests/ or
                       sample tests if the course adds them) -- a test is taken
                       in a testing setting, not stapled behind a lesson cover,
                       so it keeps its row.

See references/conventions.md ("The five conventions" -> namestrip).
