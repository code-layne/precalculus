...
\begin{tcolorbox}[colback=lilac, colframe=plum, boxrule=0.9pt, arc=2mm,
    ...
    % AP Precalculus has Mathematical Practices instead; see references/ap-workflow.md)
\end{tcolorbox}

\renewcommand{\arraystretch}{1.6}
\begin{skillbox}[Priority Ideas \& Skills]{goldbox}
    % TODO: left minipage = priority skills (Mathematical Practice + sub-skill, e.g. 2.B);
