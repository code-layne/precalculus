%! Unit 1: Functions and Change — Pretest, Version A (KEY)
%! Mirrors tests/pretest/main.tex line for line: only blank → ans,
...
\pageheader{Unit 1: Functions and Change}{Pretest (Version A) --- Skills You Bring --- Answer Key}
\namedateperiod
...
\begin{enumerate}[leftmargin=1.9em, itemsep=10pt, start=9]
  ...
  \item \begin{minipage}[t]{0.56\linewidth}
    ...
    \begin{enumerate}[label=(\alph*), itemsep=4pt]
      \item Count the length of $PQ$: \ans{6}
      \item Count the length of $QR$: \ans{8}
...
\end{work}
    ...
    \begin{enumerate}[label=(\alph*), itemsep=4pt, start=2]
      \item What is the $y$-intercept? \ans{2}
  ...
  \item \begin{minipage}[t]{0.56\linewidth}
    ...
    \begin{enumerate}[label=(\alph*), itemsep=6pt]
      ...
      \item Write the equation of the line parallel to $y = 3x + 1$ that
            crosses the $y$-axis at $(0, -2)$. \ans{$y = 3x - 2$}
    \end{enumerate}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.38\linewidth}\vspace{0pt}\centering
    \begin{tikzpicture}[scale=0.34]
  ...
  \item Set and interval notation.
    ...
    \begin{enumerate}[label=(\alph*), itemsep=8pt]
      \item In set notation, list the whole numbers from $1$ to $5$:
            \ans{$\{1, 2, 3, 4, 5\}$}
      \item Write the interval shown on the number line: \ans{$[2, \infty)$}
            \\[4pt]
      ...
      \item A ride requires riders to be \textbf{at least} $48$ inches tall.
            Write the heights $h$ allowed as an inequality: \ans{$h \ge 48$}
    \end{enumerate}
  ...
  \item A candle is $12$ inches tall when it is lit. It burns down $2$ inches
    ...
    \begin{enumerate}[label=(\alph*), itemsep=4pt]
      ...
      \item In your equation, what does the $-2$ mean about the candle?
            ...
            \writespace{1.2cm}{The candle gets 2 inches shorter every hour.}
...
\end{work}
    ...
    \begin{enumerate}[label=(\alph*), itemsep=4pt]
      \item Volume of the small box: \ans{6 in$^3$}
            \qquad Volume of the large box: \ans{48 in$^3$}
      ...
      \item A coworker says, ``Doubling every side just doubles the volume.''
            ...
            \writespace{2cm}{No. The large box holds 48 in$^3$, which is 8 times the small box, not 2 times. Each of the three sides doubles, so the volume is multiplied by $2 \cdot 2 \cdot 2 = 8$.}
    \end{enumerate}
