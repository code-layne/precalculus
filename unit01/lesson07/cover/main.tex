%! Function Model Selection and Assumption Articulation — Unit 1, Lesson 1.7 — Student Packet Cover Sheet
...
\begin{center}
  ...
  {\color{white}\textbf{\large Lesson 1.7 \quad Function Model Selection and Assumption Articulation}}
\end{center}
