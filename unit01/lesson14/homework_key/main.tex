%! Function Model Construction and Application — Unit 1, Lesson 1.14 — Homework (Answer Key)
...
\pageheader{Unit 1, Lesson 1.14}{Homework --- Answer Key}
\namedateperiod
...
\begin{teachernote}
Problem 1: the unconstrained garden (no wall) produces a square at maximum area. This contrasts with Lesson 1.14's barn example where the optimal is not square. Good discussion point.
\end{teachernote}
