%! Function Composition and Decomposition — Unit 1, Lesson 1.3 — Warm-Up
...
\end{work}
      ...
      $v(-2) = $ \blank{1.8cm} \qquad $v(1) = $ \blank{1.8cm} \qquad $v(3) = $ \blank{1.8cm}
...
\begin{enumerate}[label=(\alph*), itemsep=6pt]
  \item $(f+g)(2) = $ \blank{2.2cm} \qquad $(f-g)(4) = $ \blank{2.2cm}
