...
\begin{teachernote}
Teacher note: The correct answer is C. The function increases from $x=-2$ to $x=0$ (values $-5, 3, 4$) and decreases from $x=0$ to $x=2$ (values $4, 1, -2$). So there is a local maximum near $x=0$. There is no sign-change in AROC that indicates a local minimum within this window.
\end{teachernote}
