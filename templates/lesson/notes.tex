...
%   YOU DO : the LAST ROW — 3–4 escalating problems worked alone while the teacher
%            circulates. No objectives box (targets are on the cover).
...
\end{probgrid}
\\ \hline
% ── LAST ROW: YOU DO — alone, while the teacher circulates (11–14 min) ──────
\mainidea[You do, alone]{TODO Title} &
