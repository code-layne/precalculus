%! Rational Functions and Vertical Asymptotes — Unit 3, Lesson 3.3 — Student Packet Cover Sheet
...
\begin{center}
  ...
  {\color{white}\textbf{\large Lesson 3.3 \quad Rational Functions and Vertical Asymptotes}}
\end{center}
