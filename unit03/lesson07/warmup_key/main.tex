%! Sinusoidal Function Context and Data Modeling — Unit 3, Lesson 3.7 — Warm-Up (Answer Key)
...
\vspace{6pt}
(a)\quad What is the amplitude of $g$? \ans{3}

\vspace{4pt}
(b)\quad What is the period of $g$? \ans{$2\pi$}

\vspace{4pt}
(c)\quad What is the midline (vertical shift) of $g$? \ans{$y = 0$}
...
\vspace{6pt}
(a)\quad What is the maximum value? \ans{14}
\quad What is the minimum value? \ans{$-10$}

\vspace{4pt}
(b)\quad Compute the amplitude: $A = \dfrac{\max - \min}{2} = $ \ans{$\dfrac{14-(-10)}{2} = \dfrac{24}{2} = 12$}

\vspace{4pt}
(c)\quad Compute the midline: $D = \dfrac{\max + \min}{2} = $ \ans{$\dfrac{14+(-10)}{2} = \dfrac{4}{2} = 2$}
