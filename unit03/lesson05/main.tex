%! Sinusoidal Functions — Unit 3, Lesson 3.5 — Lesson Plan
...
\newcommand{\LessonNumberName}{Lesson 3.5: Sinusoidal Functions}
...
%-----------------------------------------------------------------------
\begin{center}
  {\Large\bfseries\color{navy} AP Precalculus \quad 2026--2027}\\[4pt]
  {\large\bfseries Unit 3: Trigonometric and Polar Functions}\\[2pt]
  {\large\bfseries Lesson 3.5: Sinusoidal Functions}\\[2pt]
  {\normalsize Instructional Periods: 2--3 \quad|\quad Meeting Length: 55 minutes}
\end{center}
