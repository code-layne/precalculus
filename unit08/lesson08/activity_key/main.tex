%! Linear Transformations and Matrices — Unit 8, Lesson 8.8 — Group Activity (Answer Key)
...
\pageheader{Unit 8, Lesson 8.8}{Group Activity --- Answer Key}
\namepartnerperiod

\vspace{0.1in}

\begin{scenariobox}[Exploring Geometric Transformations --- Key]{plumlight}
\small
