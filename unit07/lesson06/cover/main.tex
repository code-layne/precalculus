%! Trigonometry and Polar Coordinates — Unit 7, Lesson 7.6 — Student Packet Cover Sheet
...
\begin{center}
  ...
  {\color{white}\textbf{\large Lesson 7.6 \quad Trigonometry and Polar Coordinates}}
\end{center}
