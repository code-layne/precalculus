%! Logarithmic Function Context and Data Modeling — Unit 5, Lesson 5.7 — Student Packet Cover Sheet
...
\begin{center}
  ...
  {\color{white}\textbf{\large Lesson 5.7 \quad Logarithmic Function Context and Data Modeling}}
\end{center}
