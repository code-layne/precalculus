%! Sine, Cosine, and Tangent — Unit 6, Lesson 6.3 — Homework (Answer Key)
...
\begin{teachernote}
Problem 5 is a critical skill for Precalculus. The key error students make is forgetting to
