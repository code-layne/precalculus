%! Sinusoidal Function Transformations — Unit 6, Lesson 6.7 — Student Packet Cover Sheet
...
\begin{center}
  ...
  {\color{white}\textbf{\large Lesson 6.7 \quad Sinusoidal Function Transformations}}
\end{center}
