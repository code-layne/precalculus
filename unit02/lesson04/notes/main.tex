...
\begin{enumerate}[itemsep=2pt]
  \item Explain why a polynomial can have zeros that never show up as
        \blank{2.8cm} on its graph.
  \item Use the Fundamental Theorem of Algebra to count the \blank{1.4cm}
        complex zeros of a polynomial of degree $n$.
  \item Use \blank{2.4cm} pairs to name a missing zero and to build a
        polynomial from a list of zeros.
  \item Decide whether a polynomial function is \blank{1.4cm},
        \blank{1.2cm}, or neither.
\end{enumerate}
\end{objectivebox}
...
$i^2 = $ \blank{1.2cm}. A \textbf{complex number} has the form $a + bi$, where
$a$ and $b$ are real numbers.

\begin{itemize}[itemsep=4pt]
  \item $a$ is the \blank{1.8cm} part and $b$ is the \blank{2.4cm} part.
  \item Every real number is already complex: $7 = 7 + 0i$. A number is
        \textbf{non-real} exactly when $b$ \blank{1.6cm} $0$.
  \item The \textbf{complex conjugate} of $a + bi$ is \blank{2cm}. Only the
...
The $i$ terms cancelled and the answer came out \blank{1.6cm}. Remember this
...
has \textbf{exactly} \blank{1.2cm} complex zeros, counting multiplicities.
...
Setting $x^2 + 1 = 0$ gives $x^2 = -1$, so $x = $ \blank{1.6cm}. All four
zeros: $2$, $-2$, and the pair \blank{2.4cm}.
...
\hline
$(x-2)(x+2)(x^2+1)$ & \blank{0.9cm} & \blank{0.9cm} & \blank{0.9cm} & \blank{0.9cm} \\
\hline
$(x+1)^3(x^2+4)$ & \blank{0.9cm} & \blank{0.9cm} & \blank{0.9cm} & \blank{0.9cm} \\
\hline
$x(x^2+9)$ & \blank{0.9cm} & \blank{0.9cm} & \blank{0.9cm} & \blank{0.9cm} \\
\hline
$(x-1)^2(x^2+1)^2$ & \blank{0.9cm} & \blank{0.9cm} & \blank{0.9cm} & \blank{0.9cm} \\
\hline
\end{tabular}
\end{center}
\smallskip
...
real coefficients, then \blank{2cm} is also a zero.

\begin{itemize}[itemsep=4pt]
  \item Consequence 1: the number of non-real zeros of such a polynomial is
        always \blank{1.6cm} --- they cannot arrive one at a time.
  \item Consequence 2: a polynomial of \textbf{odd} degree has an odd total
        ...
        one \blank{1.8cm} zero --- its graph \textit{has} to cross the
        $x$-axis.
...
Every coefficient came out \blank{1.6cm} --- exactly what the conjugate pair
guarantees.
\end{notesbox}
...
\begin{itemize}[itemsep=4pt]
  \item $f$ is \textbf{even} when $f(-x) = $ \blank{1.4cm} for every $x$. Its
        graph is symmetric over the line \blank{1.4cm}.
  \item $f$ is \textbf{odd} when $f(-x) = $ \blank{1.6cm} for every $x$. Its
        graph is symmetric about the point \blank{1.6cm}.
...
\begin{itemize}[itemsep=4pt]
  \item Every exponent \textbf{even} $\Rightarrow$ the function is
        \blank{1.4cm}. \quad (Careful: a constant term is $x^0$, an
        \textit{even} power.)
  \item Every exponent \textbf{odd} $\Rightarrow$ the function is
        \blank{1.4cm}.
  \item A \textbf{mix} of even and odd exponents $\Rightarrow$ \blank{1.8cm}.
\end{itemize}
...
Graph A is \blank{1.4cm} (mirror over the $y$-axis); graph B is
\blank{1.4cm} (half-turn about the origin).
\end{notesbox}
...
\begin{enumerate}[itemsep=8pt]
  \item Let $p(x) = (x-6)(x^2 + 2x + 5)$. Give the degree, then list all
        ...
        Degree $= $ \blank{1.2cm} \qquad Zeros: \blank{6cm}

  \item Classify each polynomial as \textbf{even}, \textbf{odd}, or
        \textbf{neither}.

        \begin{enumerate}[label=(\alph*), itemsep=4pt]
          \item $f(x) = x^4 - 7x^2 + 1$ \quad \blank{2.2cm}
          \item $g(x) = x^5 - x$ \quad \blank{2.2cm}
          \item $h(x) = x^4 + x$ \quad \blank{2.2cm}
        \end{enumerate}
\end{enumerate}
\end{practicebox}
