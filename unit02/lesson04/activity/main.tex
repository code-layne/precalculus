...
\begin{enumerate}[itemsep=8pt]
  \item A polynomial function has degree 7. Counting multiplicities, how many
        complex zeros does it have? \quad \blank{1.6cm}
  ...
  \item Name the complex conjugate of each number. Only the sign in front of
        ...
        \begin{enumerate}[label=(\alph*), itemsep=4pt]
          \item $2 + 5i$ \quad \blank{2.4cm}
          \item $-1 + i$ \quad \blank{2.4cm}
          \item $4i$ \quad \blank{2.4cm}
          \item $3 - 7i$ \quad \blank{2.4cm}
        \end{enumerate}

  \item A polynomial with real coefficients has $6 - i$ as one of its zeros.
        Name another zero you get for free. \quad \blank{2.4cm}
\end{enumerate}
\end{tcolorbox}
...
\begin{enumerate}[itemsep=8pt]
  \item A polynomial $p$ has real coefficients, degree 3, leading coefficient
        ...
        \begin{enumerate}[label=(\alph*), itemsep=4pt]
          \item The third zero must be \blank{2cm}, because
                \blank{5.4cm}.
  ...
  \item Classify each function as \textbf{even}, \textbf{odd}, or
        ...
        \begin{enumerate}[label=(\alph*), itemsep=4pt]
          \item $f(x) = 2x^6 - x^2 + 5$ \quad \blank{2.4cm}
          \item $g(x) = -x^7 + 3x$ \quad \blank{2.4cm}
          \item $h(x) = x^4 + x^3$ \quad \blank{2.4cm}
          \item $k(x) = x^2 - 9$ \quad \blank{2.4cm}
        \end{enumerate}
...
\begin{enumerate}[itemsep=8pt]
  \item Read the graph of $p(x) = x^3 - 3x^2 + 4x - 2$ at the top of the page,
        ...
        \begin{enumerate}[label=(\alph*), itemsep=4pt]
          \item Number of $x$-intercepts on the graph: \blank{1.2cm}
          \item So the number of \textbf{real} zeros is \blank{1.2cm}
          \item The degree is \blank{1.2cm}, so the total number of complex
                zeros is \blank{1.2cm}
          \item Therefore $p$ has \blank{1.2cm} non-real zeros.
        \end{enumerate}
  ...
  \item Confirm the visible zero, then find the hidden pair. It happens that
        ...
        The two non-real zeros are \blank{4cm}. Are they a conjugate pair?
