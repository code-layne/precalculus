%! Polynomial Equations, Inequalities, and Modeling — Unit 2, Lesson 2.7 — Guided Notes
...
\begin{enumerate}[itemsep=2pt]
  \item Solve a polynomial equation by moving every term to \blank{1.6cm}
        side and applying the \blank{3cm} property.
  \item Solve a polynomial inequality by testing one value in each
        \blank{1.8cm} that the real zeros cut the number line into.
  \item Build a polynomial \blank{1.6cm} from a context and state the
        \blank{2.2cm} restriction that context forces.
...
\begin{itemize}[itemsep=4pt]
  ...
  \item $a$ is a real \blank{1.6cm} of the function $p$,
  \item $(a, 0)$ is an \blank{2.4cm} of the graph.
\end{itemize}
...
\begin{enumerate}[itemsep=3pt]
  \item Move every term to one side so the other side is \blank{1.2cm}.
  \item \blank{2.2cm} completely.
  \item Set each \blank{1.8cm} equal to zero and solve.
\end{enumerate}
...
$x \ne 0$ --- and the solution \blank{1.2cm} is exactly the one that assumption
throws away. Collect terms and factor instead; the zero-product property only
works against \blank{1.2cm}, never against any other number.
\end{notesbox}
...
passing through \blank{1.2cm}. So between two consecutive real zeros there is
nowhere for the sign to change: on that whole interval the sign
\blank{3.2cm}. One \textbf{test value} therefore settles the entire interval.
...
\hline
\textbf{Sign of $p$} & \blank{1.2cm} & \blank{1.2cm} & \blank{1.2cm} & \blank{1.2cm} \\
\hline
\end{tabular}
\end{center}
\smallskip
...
\begin{itemize}[itemsep=4pt]
  \item \textbf{Odd} multiplicity at a zero $\Rightarrow$ the sign
        \blank{2.4cm} there (the graph crosses).
  \item \textbf{Even} multiplicity at a zero $\Rightarrow$ the sign
        \blank{2.6cm} there (the graph is tangent and turns back).
\end{itemize}

\textbf{Example 3.} Solve $(x+2)(x-1)^2 > 0$.

Zeros: $-2$ with multiplicity \blank{0.9cm} and $1$ with multiplicity
\blank{0.9cm}.
...
problem asked for $\ge$, the solution would have been \blank{4cm} instead.
\end{notesbox}
...
\begin{itemize}[itemsep=4pt]
  \item Height of the box: \blank{2cm}
  \item Width: $20 - $ \blank{1.4cm} \quad (\textit{two} corners come off that
        side, not one)
  \item Length: $30 - $ \blank{1.4cm}
\end{itemize}
...
\begin{itemize}[itemsep=4pt]
  \item A cut has positive length: $x >$ \blank{1cm}
...
is \blank{3.4cm}. \textbf{No step of the algebra produced that.} It came from
the scenario, and a model without it is not finished.
\end{notesbox}
...
and a useless answer to the question, because \blank{6cm}.
...
\textbf{Test value} & \blank{1.2cm} & \blank{1.2cm} & \blank{1.2cm} \\
\hline
\textbf{Is $V(x) \ge 1000$?} & \blank{1.2cm} & \blank{1.2cm} & \blank{1.2cm} \\
\hline
\end{tabular}
\end{center}
\smallskip
...
\textit{you} still pick the \blank{1.8cm}, and you still have to say what the
...
\begin{enumerate}[itemsep=8pt]
  ...
  \item Solve $(x-1)(x+4) \le 0$. Zeros: $-4$ and $1$.
        ...
        \begin{enumerate}[label=(\alph*), itemsep=4pt]
          \item Sign on $(-\infty,-4)$: \blank{1.4cm} \quad
                on $(-4,1)$: \blank{1.4cm} \quad
                on $(1,\infty)$: \blank{1.4cm}
