%! Logarithmic Function Context and Data Modeling — Unit 2, Lesson 2.14 — Slides (Beamer)
...
\begin{frame}[plain]
  ...
  \begin{minipage}{0.9\textwidth}
    ...
    {\color{skymid}\small AP Precalculus~$\cdot$~Unit 2: Exponential and Logarithmic Functions}
  \end{minipage}
\end{frame}
}
