%! Introduction to Polynomial Functions — Unit 2, Lesson 2.0 — Group Activity
...
\textbf{Letter} & \textbf{Polynomial?} & \textbf{Degree} \\
\hline
A & yes & 3 & E & \blank{1.4cm} & \blank{1.4cm} \\
\hline
B & \blank{1.4cm} & \blank{1.4cm} & F & \blank{1.4cm} & \blank{1.4cm} \\
\hline
C & \blank{1.4cm} & \blank{1.4cm} & G & \blank{1.4cm} & \blank{1.4cm} \\
\hline
D & \blank{1.4cm} & \blank{1.4cm} & H & \blank{1.4cm} & \blank{1.4cm} \\
\hline
\end{tabular}
\smallskip

\begin{enumerate}[itemsep=6pt]
  \item How many of the eight are polynomials? \quad \blank{1.6cm}
...
\hline
$7x - 4 + x^3$ & \blank{2.9cm} & \blank{1.1cm} & \blank{1.3cm} & \blank{1.3cm} \\
\hline
$2 - 5x^2$ & \blank{2.9cm} & \blank{1.1cm} & \blank{1.3cm} & \blank{1.3cm} \\
\hline
$x - 6x^4 + 3x^2$ & \blank{2.9cm} & \blank{1.1cm} & \blank{1.3cm} & \blank{1.3cm} \\
\hline
\end{tabular}
\smallskip
...
\begin{enumerate}[itemsep=8pt]
  \item Name each of the three by its degree family (linear, quadratic, cubic,
        ...
        First: \blank{2.6cm} \quad Second: \blank{2.6cm} \quad
        Third: \blank{2.6cm}
...
\begin{enumerate}[itemsep=8pt]
  \item Four expressions in the bank are impostors. For each, name the rule it
        ...
        \hline
        B & \blank{2.9cm} & \blank{4.2cm} \\
        \hline
        D & \blank{2.9cm} & \blank{4.2cm} \\
        \hline
        G & \blank{2.9cm} & \blank{4.2cm} \\
        \hline
        H & \blank{2.9cm} & \blank{4.2cm} \\
        \hline
        \end{tabular}
