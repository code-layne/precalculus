%! Inverses of Exponential Functions — Unit 2, Lesson 2.10 — Student Packet Cover Sheet
...
\begin{center}
  ...
  {\color{white}\textbf{\large Lesson 2.10 \quad Inverses of Exponential Functions}}
\end{center}
