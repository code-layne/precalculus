%! Semi-log Plots — Unit 2, Lesson 2.15 — Lesson Plan
...
\newcommand{\LessonNumberName}{Lesson 2.15: Semi-log Plots}
...
\begin{tabularx}{\linewidth}{@{} >{\bfseries\color{navy}}p{0.33\linewidth} X @{}}
